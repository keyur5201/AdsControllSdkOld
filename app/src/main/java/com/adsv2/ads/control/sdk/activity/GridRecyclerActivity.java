...
//        });
    ...
    private void addMenuItemsFromJson(int adSize) {
        try {
            ...
            new RecycleviewAdManager(this).ShowNativeAdInRecyclerView(adSize, mainList, true, new AdspterSet() {
                @Override
                public void onAddDataFinish(RecyclerView.LayoutManager manager) {
                    recyclerView.setLayoutManager(manager);
                    adapter = new RecyclerAdapter(GridRecyclerActivity.this, mainList);
